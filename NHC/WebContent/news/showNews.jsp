...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <li>></li>
    <li><a href="../news/NewsList">最新消息</a></li>
  ...
  <tr>
    <td valign="top"><%=article.getContent()%> 
    </td>
    </tr>
  ...
  <tr>
    ...
    <ul>
    <li><a href="#"><img src="images/excel.png" width="28" height="29" alt="excel" /><p>某某檔案</p></a></li>
    <li><a href="#"><img src="images/pdf.png" width="26" height="29" alt="pdf" /><p>某某檔案</p></a></li>
    <li><a href="#"><img src="images/word.png" width="26" height="29" alt="pdf" /><p>某某檔案</p></a></li>
    </ul></td>
  </tr>--->
</table>
