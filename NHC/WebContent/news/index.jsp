...
if(request.getParameter("cid")!=null){
	...
	id2 = Integer.parseInt(request.getParameter("mid"));
	...
	rs = op.query("SELECT * from cms_infodata where cms_infodata_class="+id+" and cms_infodata_iscoment="+id2+" and cms_infodata_uptime<='"+ddate+"' and cms_infodata_dntime>='"+ddate+"' order by cms_infodata_id desc");
	rs.next();
...
<table width="660" border="0" cellspacing="0" cellpadding="0">
	...
	int pageCount = 0; 
	//獲得記錄總數
	rs = op.query("SELECT COUNT(*) AS total from cms_infodata where cms_infodata_class="+id+" and cms_infodata_iscoment="+id2+" and cms_infodata_uptime<='"+ddate+"' and cms_infodata_dntime>='"+ddate+"'");
	while(rs.next()){
	...
	rs = op.query("SELECT * from cms_infodata where cms_infodata_class="+id+" and cms_infodata_iscoment="+id2+" and cms_infodata_uptime<='"+ddate+"' and cms_infodata_dntime>='"+ddate+"' order by CMS_INFODATA_RELEASETIME desc ," + pageSize);
  %>
