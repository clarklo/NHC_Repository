...
<title>高雄榮民總醫院國際醫療中心-心情故事</title>
...
<table width="960" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div class="menu_title"><img src="../images/menu_pic09.png" width="231" height="81" alt="心情故事" /></div>
...
<table width="660" border="0" cellspacing="0" cellpadding="0">
	...
	//以CMS_INFODATA_RELEASETIME排序
	rs = op.query("SELECT * from cms_infodata where cms_infodata_class="+id+" order by CMS_INFODATA_RELEASETIME desc ," + pageSize);
  %>
