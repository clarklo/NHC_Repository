...
String f = calendar.get(Calendar.YEAR)+"/"+(calendar.get(Calendar.MONTH)+1)+"/"+calendar.get(Calendar.DAY_OF_MONTH)+"/"+x+"."+myFile.getFileExt();

out.println("parent.parent.myform.imgfile.value += '"+f+":';");
out.println("parent.parent.myform.indexImage.value='"+f+"';");
out.println("parent.parent.myform.DefaultPicList.options[parent.parent.myform.DefaultPicList.length] = new Option('"+x+"."+myFile.getFileExt()+"','" +f+ "');");
out.println("parent.parent.myform.DefaultPicList.selectedIndex+=1;");
