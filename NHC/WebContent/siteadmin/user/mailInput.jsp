...
.SUBMIT ul li .submit-button_c:active {
        ...
        <div class="mail_bg">
            <div class="mail_input">
                <ul>
                   ...
                   <li>Subject:<input id="subject" class="w_in10" size="40" type="text" name="subject" value=" ?????? "></li>	
                   <li>mailTo:<input id="mailto" class="w_in10" type="text" size="40" name="to" value="iclee@vghks.gov.tw"></li>
            ...
            <div class="SUBMIT">
                 <ul>
                    <li><input class="submit-button_c" type="submit" value="??" name="send"/></li>
                    <li><input class="submit-button" type="reset" value="??"  name="reset"/></li>
                </ul>
            </div>
        </div>
        </form>
    ...
    <!--<body>
        <h1>Send Mail</h1>
        <form method="post" action="sendGMail.jsp">
          From Email:<input type="hidden" name="from" value="ihaoyu.gvkhs@gmail.com" />

          To Email  :<input type="text" name="to" value="iclee@vgkhs.com.tw">

          Subject   :<input type="hidden" name="subject" value="??????????">

          Content   :<textarea name="content" cols="80" rows="6"></textarea>
          <input type="hidden" name="from" value="ihaoyu.gvkhs@gmail.com" />
