...
public class UserList extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/**
		 * 以下參數由userList.jsp頁面傳過來的查詢條件
		 */
		String check=request.getParameter("check");//審核狀態
		String loginname=request.getParameter("loginname");//登錄名
		String userid=request.getParameter("userid");
		//以下參數由userList.jsp頁面傳過來的排序參數
		//String order=request.getParameter("order");//0為按個人積分排序，１為按財富排序
		//以下為審核會員
