...
//	數據庫操作對象
	...
	{   LeaveWord l = new LeaveWord();
		try
		{
			...
			leaveword.setUser_addr(rs.getString("user_addr"));
	...
	public void addLeaveWord()
	{
		try
		{
			...
			//////
			sql="INSERT INTO leaveword ( l_title,l_content,l_reply,l_time,l_email,l_user,l_class_id,user_sex,user_company,user_tel,user_addr) VALUES ('"+leaveword.getL_title()+"','"+leaveword.getL_content()+"','"+leaveword.getL_reply()+"',current timestamp,'"+leaveword.getL_email()+"','"+leaveword.getL_user()+"','"+leaveword.getL_class_id()+"','"+leaveword.getUser_sex()+"','"+leaveword.getUser_company()+"','"+leaveword.getUser_tel()+"','"+leaveword.getUser_addr()+"')";
