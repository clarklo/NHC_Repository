...
public class LeaveWordList extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		/**
		 * 以下參數由leavewordList.jsp頁面傳過來的查詢條件
		 */
		String l_class=request.getParameter("class");//按留言類別來搜索
		String isreply=request.getParameter("isreply"); //按是否回複來搜索 若為"0"則是按未回複搜索，是"1"則按已回複來搜索
